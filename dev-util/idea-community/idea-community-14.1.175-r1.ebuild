...
#http://download.jetbrains.com/idea/ideaIC-141.175.3.tar.gz
SRC_URI="http://download-cf.jetbrains.com/${MY_PN}/${MY_PN}IC-141.175.3.tar.gz"
LICENSE="Apache-2.0"
IUSE=""
KEYWORDS="~amd64 ~x86"
S="${WORKDIR}/${MY_PN}-IC-141.175.3"
