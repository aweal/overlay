...
DRIVERS_URI="amd-driver-installer-15.20.1046-x86.x86_64.zip"
...
pkg_nofetch() {
    if [ ! -f "$SDISTDIR/$DRIVERS_URI" ]; then
	echo "File not found!"
	...
	einfo 
	einfo "chown portage:portage /usr/portage/distfiles/amd-driver-installer-15.20.1046-x86.x86_64.zip "
	einfo 
	einfo "If the above mentioned urls do not point to the correct version anymore,"
	einfo "please download the files from AMD download archive:"
	einfo
	einfo "  http://www2.ati.com/drivers/linux/amd-driver-installer-15.20.1046-x86.x86_64.zip "
	einfo
    fi
...
src_prepare() {
	...
	#548118
	epatch "${FILESDIR}"/ati-drivers-15.7.patch
	
	epatch "${FILESDIR}"/ati-drivers-15.7-gpl.patch
